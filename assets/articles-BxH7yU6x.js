function l(e){return e?e.replace(/<[^>]+>/g," ").replace(/\s+/g," ").trim():""}function p(e,t=190){if(!e)return 0;const i=l(e);if(!i)return 0;const s=i.split(/\s+/).filter(Boolean).length;return Math.max(1,Math.round(s/t))}const c=new Intl.DateTimeFormat("fr-FR",{day:"numeric",month:"long",year:"numeric"});function o(e){return[...e].sort((t,i)=>{const s=new Date(t.published_at??t.created_at??0).getTime();return new Date(i.published_at??i.created_at??0).getTime()-s})}function d(e){const t=e.published_at??e.created_at;return t?c.format(new Date(t)):"Date à venir"}function m(e,t=200){var s;if((s=e.excerpt)!=null&&s.trim()){const r=e.excerpt.trim();return r.length>t?`${r.slice(0,t)}...`:r}const i=l(e.content??"");return i?i.length>t?`${i.slice(0,t)}...`:i:""}function v(e,t,i=3){const s=t.filter(a=>a.slug!==e.slug),r=s.filter(a=>!!e.category&&!!a.category&&a.category.toLowerCase()===e.category.toLowerCase());if(r.length>=i)return o(r).slice(0,i);const u=s.filter(a=>{var n;return!e.category||((n=a.category)==null?void 0:n.toLowerCase())!==e.category.toLowerCase()});return o([...r,...u]).slice(0,i)}const h=[{id:"demo-article-1",slug:"comment-choisir-mutuelle-sante",title:"Comment bien choisir sa mutuelle santé en 2025",category:"Santé",excerpt:"Découvrez nos conseils pour sélectionner la mutuelle santé qui correspond vraiment à vos besoins et à votre budget.",content:`
    ...
    `,cover_url:"https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1600&q=80&auto=format&fit=crop",thumbnail_url:"https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80&auto=format&fit=crop",tags:["Mutuelle","Santé","Conseils"],author_id:null,author_name:"Marie Dubois",is_published:!0,published_at:"2025-01-15T08:00:00Z",created_at:"2025-01-15T08:00:00Z",updated_at:"2025-01-15T08:00:00Z"},{id:"demo-article-2",slug:"prevoyance-pourquoi-essentielle",title:"Pourquoi la prévoyance est essentielle pour protéger votre famille",category:"Prévoyance",excerpt:"Protéger ses proches en cas d'imprévu : comprendre l'importance d'une assurance prévoyance adaptée.",content:`
    ...
    `,cover_url:"https://images.unsplash.com/photo-1511895426328-dc8714191300?w=1600&q=80&auto=format&fit=crop",thumbnail_url:"https://images.unsplash.com/photo-1511895426328-dc8714191300?w=800&q=80&auto=format&fit=crop",tags:["Prévoyance","Famille","Protection"],author_id:null,author_name:"Jean Martin",is_published:!0,published_at:"2025-01-12T08:00:00Z",created_at:"2025-01-12T08:00:00Z",updated_at:"2025-01-12T08:00:00Z"},{id:"demo-article-3",slug:"assurance-auto-jeunes-conducteurs",title:"Assurance auto : 7 conseils pour jeunes conducteurs",category:"Auto",excerpt:"Jeune conducteur ? Découvrez comment réduire le coût de votre assurance auto tout en restant bien protégé.",content:`
    ...
    `,cover_url:"https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=1600&q=80&auto=format&fit=crop",thumbnail_url:"https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800&q=80&auto=format&fit=crop",tags:["Auto","Jeunes conducteurs","Budget"],author_id:null,author_name:"Sophie Laurent",is_published:!0,published_at:"2025-01-10T08:00:00Z",created_at:"2025-01-10T08:00:00Z",updated_at:"2025-01-10T08:00:00Z"},{id:"demo-article-4",slug:"assurance-habitation-locataire",title:"Assurance habitation : ce que doit savoir un locataire",category:"Habitation",excerpt:"Locataire ? Votre assurance habitation est obligatoire. Voici tout ce qu'il faut savoir pour être bien couvert.",content:`
    ...
    `,cover_url:"https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1600&q=80&auto=format&fit=crop",thumbnail_url:"https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80&auto=format&fit=crop",tags:["Habitation","Locataires","Protection"],author_id:null,author_name:"Pierre Durand",is_published:!0,published_at:"2025-01-08T08:00:00Z",created_at:"2025-01-08T08:00:00Z",updated_at:"2025-01-08T08:00:00Z"}];export{v as a,h as d,p as e,d as f,m as g,o as s};
