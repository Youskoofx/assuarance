...
export default function HeroSection() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="not-prose max-w-7xl mx-auto px-8 relative z-10 text-center">
        <motion.h1
          className="text-white text-5xl md:text-6xl lg:text-8xl font-bold leading-tight mb-4 md:mb-6 no-underline decoration-transparent [text-decoration:none]"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          Votre courtier d'assurances à{' '}
          <span className="text-teal-400 no-underline decoration-transparent [text-decoration:none]">
            Gennevilliers
          </span>
        </motion.h1>
